...
#ifndef PEOPLE_COUNTER_HELPER_H
#define PEOPLE_COUNTER_HELPER_H
...
/**
 * This class can install People Counter applications on multiple nodes at once.
 */
class PeopleCounterHelper
{
public:
  PeopleCounterHelper ();
...
private:
  void InstallComponents (Ptr<PeopleCounter> netServer);
