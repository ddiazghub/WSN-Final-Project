...
NS_LOG_COMPONENT_DEFINE ("PeopleCounterHelper");

PeopleCounterHelper::PeopleCounterHelper ()
{
  m_factory.SetTypeId ("ns3::PeopleCounter");
...
void
PeopleCounterHelper::SetAttribute (std::string name, const AttributeValue &value)
{
  m_factory.Set (name, value);
}

void
PeopleCounterHelper::SetGateways (NodeContainer gateways)
{
  m_gateways = gateways;
}

void
PeopleCounterHelper::SetEndDevices (NodeContainer endDevices)
{
  m_endDevices = endDevices;
}

ApplicationContainer
PeopleCounterHelper::Install (Ptr<Node> node)
{
  return ApplicationContainer (InstallPriv (node));
}

ApplicationContainer
PeopleCounterHelper::Install (NodeContainer c)
{
...
Ptr<Application>
PeopleCounterHelper::InstallPriv (Ptr<Node> node)
{
  NS_LOG_FUNCTION (this << node);

  Ptr<PeopleCounter> app = m_factory.Create<PeopleCounter> ();
  ...
  // Add components to the PeopleCounter
...
void
PeopleCounterHelper::EnableAdr (bool enableAdr)
{
...
void
PeopleCounterHelper::SetAdr (std::string type)
{
...
void
PeopleCounterHelper::InstallComponents (Ptr<PeopleCounter> netServer)
{
